<script lang="ts">
	...
	let { node, parameterEntries = [], onUpdate, onClose }: Props = $props();
...
<div class="absolute right-0 top-0 h-full w-72 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 overflow-y-auto z-20 shadow-lg">
